...
- Focused on clarity, usability, and clean visual hierarchy  

🔹 UI/UX Design Works
- Business website designs  
- Landing pages and redesign concepts  
- Figma-based case studies  

---

📄 Resume
📎 My resume is included in this repository and can also be accessed through the portfolio website.
...
# Goals
- Secure a UI/UX or front-end development internship  
- Work on real-world projects with experienced professionals  
